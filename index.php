...
<head>
    ...
    <div id="nav-head" class="header-nav">
        <div class="container">
            <div class="row">
                <!-- Hospital Logo and HMS Health -->
                <div class="col-lg-2 col-md-3 col-sm-12 d-flex align-items-center">
                    <!-- Add the hospital logo -->
                    <img src="assets/images/hms-logo.png" alt="Hospital Logo" style="max-width:150px; height:auto; margin-right:20px;">
                    <!-- HMS Health styled text -->
                ...
                <div id="menu" class="col-lg-8 col-md-9 d-none d-md-block nav-item">
                    <ul>
                        ...
                        <li><a href="room.html">Accommodation</a></li>
            ...
            <div class="carousel-inner">
                <div class="carousel-item ">
                    ...
                    <div class="carousel-caption vdg-cur d-none d-md-block">
                        <h5 class="animated bounceInDown">HMS Health Care </h5>
                ...
                <div class="row no-margin">
                    <div class="col-sm-4 blog-smk">
                        <div class="blog-single">
                                ...
                                <img src="assets/images/patient_1.jpg" alt="">
                    ...
                    <div class="col-sm-4 blog-smk">
                        <div class="blog-single">
                                ...
                                <img src="assets/images/doctor_1.jpg" alt="">
                    ...
                    <div class="col-sm-4 blog-smk">
                        <div class="blog-single">
                                ...
                                <img src="assets/images/admin_1.jpg" alt="">
    ...
    <section id="services" class="key-features department">
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="single-key" onclick="location.href='baby.html'" style="cursor: pointer;">
                        <i class="fas fa-heartbeat"></i>
                        <h5>Mother and Baby Care</h5>
                    </div>
                </div>

                <div class="col-lg-4 col-md-6">
                <div class="single-key" onclick="location.href='cancer.html'" style="cursor: pointer;">
                        <i class="fas fa-ribbon"></i>
                        <h5>Cancer and Care </h5>
                    </div>
                </div>
                ...
                <div class="single-key" onclick="location.href='heartcare.html'" style="cursor: pointer;">
                        <i class="fas fa-capsules"></i>
                        <h5>Heart and Care </h5>
                    </div> 
                </div>

                <div class="col-lg-4 col-md-6">
                <div class="single-key" onclick="location.href='lab.html'" style="cursor: pointer;">
...
?>
    ...
    <p><?php  echo $row['PageDescription'];?>.</p><?php } ?>
        ...
        <br/>
            ...
            <div class="gallery_product col-lg-4 col-md-4 col-sm-4 col-xs-6 filter hdpe">
                <img src="assets/images/gallery/dental.jpeg" class="img-responsive">
            </div>

            <div class="gallery_product col-lg-4 col-md-4 col-sm-4 col-xs-6 filter sprinkle">
                <img src="assets/images/gallery/lab.jpg" class="img-responsive">
            </div>
    ...
    <style>
        ...
        .gallery {
            background: url('your-gallery-background.jpg') no-repeat center center/cover;
            padding: 80px 20px;
            text-align: center;
            color: white;
        }
        ...
        /* Additional styles for a smooth experience */
    ...
    <div class="feedback-section">
        ...
        <div class="feedback-container">
            <div class="feedback">
                <p>"I received excellent care at the hospital. The staff made sure I felt comfortable and well-taken care of at all times."</p>
                <span>- Umanda Abeykoon</span>
            </div>
            <div class="feedback">
                <p>"The environment here was very calming and helped me focus on my recovery. Everyone was so supportive and kind."</p>
                <span>- Anil Jaye</span>
            </div>
            <div class="feedback">
                <p>"I was thoroughly impressed with the professionalism and kindness of the nurses and doctors. They really went above and beyond."</p>
                <span>- Dihara Dayarathne</span>
            </div>
            <div class="feedback">
                <p>"Clean facilities, prompt service, and a great team of doctors. I would definitely recommend this hospital to others."</p>
                <span>- Minsadi Liyanawaduge</span>
            </div>
        </div>
    </div>
...
<?php
$ret=mysqli_query($con,"select * from tblpage where PageType='' ");
while ($row=mysqli_fetch_array($ret)) {
?>
